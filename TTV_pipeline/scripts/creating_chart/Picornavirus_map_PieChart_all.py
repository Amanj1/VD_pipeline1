...
contigs_magicblast = glob.glob('/home/amanj/Documents/picornavirus_results_T1D_ABIS/P13408/picorna_map_results/all/contigs/magicblast/*.tsv')
reads_magicblast = glob.glob('/home/amanj/Documents/picornavirus_results_T1D_ABIS/P13408/picorna_map_results/all/reads/magicblast/*.tsv')
reads_bwa = glob.glob('/home/amanj/Documents/picornavirus_results_T1D_ABIS/P13408/picorna_map_results/all/reads/BWA/*.tsv')

File_output = "All_Picornavirus_mapping_PieCharts.html"
...
def main():     
 ...
 ###################HTML_CODE_END############################
  ...
  ###################BWA############################
        ...
        func_bwa_3_mid = """
        // Optional; add a title and set the width and height of the chart
        var options3 = {'title':'Picornavirus reference occurrences (BWA reads)', 'width':1250, 'height':1100};
        ...
        for c in content:
            ...
            if run == 0:
                sample_id = str(tmp[0])
                ttv_in_sample = str(tmp[7]).replace("'", "_")
   ...
   ###################MAGICBLAST READS############################       
        ...
        func_blast_6_mid = """
        // Optional; add a title and set the width and height of the chart
        var options6 = {'title':'Picornavirus reference occurrences (Magicblast reads)', 'width':1250, 'height':1100};
...
###################MAGICBLAST CONTIGS############################       
        ...
        func_blast_9_mid = """
        // Optional; add a title and set the width and height of the chart
        var options9 = {'title':'Picornavirus reference occurrences (Magicblast contigs)', 'width':1250, 'height':1100};
