...
#Magic-BLAST reads
magic_blast_selected_reads = glob.glob('/home/amanj/Documents/results_picornavirus/new_results_200219/P13409_picorna_map_results/P*/reads/magicblast/*selected_reads_magicblast.txt')
magic_blast_sample_results_reads = glob.glob('/home/amanj/Documents/results_picornavirus/new_results_200219/P13409_picorna_map_results/P*/reads/magicblast/*sample_results_magicblast_reads.txt')
#BWA reads
bwa_selected_reads = glob.glob('/home/amanj/Documents/results_picornavirus/new_results_200219/P13409_picorna_map_results/P*/reads/BWA/*selected_reads_bwaBed.txt')
bwa_sample_results_reads = glob.glob('/home/amanj/Documents/results_picornavirus/new_results_200219/P13409_picorna_map_results/P*/reads/BWA/*sample_results_bwaBed_reads.txt')
#Magic-BLAST contigs
magic_blast_selected_contig = glob.glob('/home/amanj/Documents/results_picornavirus/new_results_200219/P13409_picorna_map_results/P*/contigs/magicblast/*selected_contig_magicblast.txt')
magic_blast_sample_results_contig = glob.glob('/home/amanj/Documents/results_picornavirus/new_results_200219/P13409_picorna_map_results/P*/contigs/magicblast/*sample_results_magicblast_contig.txt')
    ...
    for sel_con in f_lines:
        for samp_res in f1_lines:
            if sel_con.split('\t')[0] == samp_res.split('\t')[1]:
                ...
                tmp.append("-") 
                tmp.append("true")
                tmp.append(sel_con.split('\t')[2].rstrip())                
    ...
    for i in range(len(magicblast_con)):
        for j in range(len(bwa_con)):
            ...
            if bwa_con[j][2] == magicblast_con[i][2]:
                bwa_con[j][7] = magicblast_con[i][7]
                bwa_con[j][8] = magicblast_con[i][8]
                index = -1
                break
        if index != -1:
...
def main():
    ...
    for m in range(len(magic_blast_selected_contig)):
        ...
        for r in reads_container:
            ...
            f.write(tmp)
    f.close() 
    Header = ['sample_id', 'type_of_data', 'seq_id', 'accession_number', 'ref_name', 'bwa', 'bwa_score', 'magicblast', 'magicblast_score']
